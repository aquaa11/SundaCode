export const dataKamus = [
  ...
  },
  {
    ...
    kode: true,
    contohkode: `connection.query('SELECT * FROM mahasiswa', (error, results, fields) => {if (error) throw error;
  ...
  },
  {
    ...
    kode: true,
    contohkode: `// Fungsi untuk menghitung luas segitiga
    function hitungLuasSegitiga(alas, tinggi) {
      return (alas * tinggi) / 2;
    }
    
    // Panggil fungsi hitungLuasSegitiga dengan nilai alas dan tinggi yang tidak valid (string)
    const luas = hitungLuasSegitiga('a', 'b');
  ...
  },
  {
    ...
    kode: true,
    contohkode: `// Masihan panjang sisi persegi
      const panjang_sisi = 5;
      
      // Hitung luas persegi
      const luas_persegi = panjang_sisi * panjang_sisi;
      
      // Tampi nilai luas
      console.log("Luas persegi jeung panjang sisi", panjang_sisi, "teh", luas_persegi);
      `,
  },
  {
    id: "0042",
  ...
  },
  {
    ...
    kode: true,
    contohkode: "//global di luar sini {local di dalam sini}",
  },
  {
    id: "0047",
    kosakata: "parameter",
