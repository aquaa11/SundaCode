      ...
      <section id="hero" className="pt-44 mx-auto w-full max-w-screen-xl">
        <div className="px-5 md:text-center text-3xl md:text-4xl font-bold text-primary">
          ...
          <p className="font-normal text-base mt-4 mx-auto">
            Web ini dibuat oleh siswa SMKN 2 CIMAHI untuk mempelajari sekaligus
            melestarikan bahasa sunda. Kami adalah sekelompok siswa yang
            terobsesi dengan dunia coding dan kecintaan akan budaya Sunda.
            Bersatu dalam semangat eksplorasi dan keingintahuan, kami telah
            menciptakan sebuah website yang memadukan keindahan bahasa Sunda
            dengan kecanggihan teknologi coding.
            <br />
            <br />
            Di dalam website kami, Anda akan menemukan penjelasan yang
            menyeluruh tentang coding, namun disajikan dengan bahasa yang lembut
            dan manis seperti lagu alam Sunda. Kami percaya bahwa belajar
            haruslah sebuah pengalaman yang menyenangkan dan menginspirasi.
            <br />
            <br />
      ...
      <section className="bg-primary py-3 md:py-4 mx-auto w-full mt-32 md:mt-48">
        <div className="w-full border-y border-white py-5">
          <div className="max-w-screen-lg mx-auto ">
            <h1 className="text-3xl inline bg-primary font-bold tracking-tight text-pink px-4 md:px-6 absolute left-1/2 -translate-x-1/2 -translate-y-20 border border-white py-1">
              Our Team
            </h1>
            <div className="grid md:grid-cols-2 gap-y-10 gap-x-4 max-w-screen-lg mx-auto my-10">
              <div className="max-w-[18rem] w-full md:max-w-md md:flex mx-auto overflow-hidden rounded">
                <div className="w-full md:w-[47%] h-64 md:h-full mx-auto">
                  <img
                    src="./Wafiyana.jpeg"
                ...
                <div className="border-r md:w-[53%] border-b border-l rounded-es rounded-ee md:rounded-es-none md:rounded-se border-white  md:border-l-0 md:border-t  p-4">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-4">
                      "Dibalik indahnya langit senja, ada manusia yang ga solat
                      magrib."
                    </p>
              ...
              <div className="max-w-[18rem] w-full md:max-w-md md:flex mx-auto overflow-hidden rounded">
                <div className="w-full md:w-[47%] h-64 md:h-full mx-auto">
                  {" "}
                  <img src="./Dzika.jpeg" className="size-full object-cover" />
                </div>
                <div className="border-r md:w-[53%] border-b border-l rounded-es rounded-ee md:rounded-es-none md:rounded-se border-white  md:border-l-0 md:border-t  p-4">
                  <div>
                    <span
                    ...
                    <p className="text-gray-500 text-sm mt-4">
                      "Kau akan kehilangan bulan,karena sibuk menghitung
                      bintang."
                    </p>
              ...
              <div className="max-w-[18rem] w-full md:max-w-md md:flex mx-auto overflow-hidden rounded">
                <div className="w-full md:w-[47%] h-64 md:h-full mx-auto overflow-hidden">
                  {" "}
                  <img src="./Fadly.jpeg" className="size-full object-cover" />
                </div>
                <div className="border-r md:w-[53%] border-b border-l rounded-es rounded-ee md:rounded-es-none md:rounded-se border-white  md:border-l-0 md:border-t  p-4">
                  <div>
                    <span
              ...
              <div className="max-w-[18rem] w-full min-h-56 md:max-w-md md:flex mx-auto overflow-hidden rounded">
                <div className="w-full md:w-[47%] h-64 md:h-full mx-auto overflow-hidden">
                  {" "}
                  <img
                    src="./Rakha.jpeg"
