  ...
  return (
    <main>
      <section className="w-full px-5">
        <div className="text-left sm:text-center mt-48 sm:mt-56 text-3xl sm:text-4xl font-extrabold sm:font-bold">
          <h3>
      ...
      <section className="mt-64 sm:mt-72 bg-primary px-3 sm:px-14 py-4 sm:py-5">
        ...
        <div className="px-5 pt-6 pb-8 pb sm:py-6 sm:px-8 bg-white flex w-full max-w-screen-xl flex-col sm:flex-row mx-auto gap-5 sm:gap-10">
          <div className="bg-white p-2 border-pink border w-full sm:w-1/2 h-80 sm:h-[22rem]">
            <div className="w-full bg-[url('/KamusSundacode.png')] bg-cover bg-no-repeat h-full"></div>
          </div>
        ...
        <div className="px-5 border border-pink pt-6 pb-8 my-10 sm:py-6 sm:px-8 flex w-full flex-col sm:flex-row max-w-screen-xl mx-auto gap-5 sm:gap-10">
          ...
          <div className="bg-white h-[460px] sm:bg-center md:w-1/4">
            <img className="bg-cover bg-bottom sm:bg-center w-full h-full" src="./poster-pamali.jpg"></img>
          </div>
        </div>
        <div className="px-5 pt-6 pb-8 pb sm:py-6 sm:px-8 bg-white flex w-full max-w-screen-xl flex-col sm:flex-row mx-auto gap-5 sm:gap-10">
          <div className="bg-white w-full sm:w-1/2 h-80 sm:h-[22rem]">
            <div className="w-full bg-[url('/kelompok-raizan.png')] brightness-50 hover:brightness-75 transition-all bg-cover bg-no-repeat h-full"></div>
          </div>
          <div className="w-full sm:w-1/2">
            <h1 className="text-lg sm:text-2xl text-pink font-bold">
      ...
      <div className="content3 max-w-screen-xl mx-auto mt-16">
        <div className="tittle3">
          <h3 className="text-xl sm:text-3xl">DIBUAT MENGGUNAKAN</h3>
        </div>
        <div className="gambar justify-center flex flex-wrap mx-auto mt-10">
          <div className="html">
            <svg
              viewBox="0 0 32 32"
              fill="none"
